...
Write-Host 'agente fiscal e abre a configuracao passo a passo. A biblioteca da PayGo ja vai'
Write-Host 'dentro (pasta pgweb); na loja falta so instalar o ponto de captura em TEF.'
Write-Host ''
