...
public static class RoteiroTef
{
    ...
    public static readonly IReadOnlyList<PassoTef> Passos = new PassoTef[]
    {
        ...
        new(11, "Venda por QRCode para PIX e Carteiras Digitais", "SIM", "", "pronto",
            "Abre a venda, toca em PIX, confirma o valor e vira a tela do caixa para o cliente ler o QR com o aplicativo do banco. A aprovação chega sozinha.",
            "A janela do QR abrindo com o código grande e legível. Aprovação automática, recibo impresso e a janela fechando sozinha no fim. tef_transacao 'pago' com campo 010 = PIX C6 BANK e o NSU virando carimbo do fechamento (Pagamento.xaml.cs:602-603). Na auditoria, a linha \"exibir tipo=20 ... qr=N caracteres\", que prova de onde o QR veio. A rede PIX C6 BANK já está gravada em tef_paygo_rede_pix, então…"),
        ...
        new(17, "Manutenção", "SIM", "", "pronto",
            "Configuração, botão ADM, escolhe MANUTENÇÃO na lista da maquininha e responde o que ela pedir. Se pedir a senha do lojista, o campo aparece sem eco.",
        ...
        new(18, "Reinstalação/Instalação", "SIM", "", "depende da PayGo",
            "Configuração, seção da maquininha, toca em \"Instalar ponto de captura\". A biblioteca pergunta os dados na tela do caixa (CNPJ, ponto de captura, senha) e quem digita é o dono.",
        ...
        new(55, "Operacao cancelada durante venda PIX (Esc na tela do QRCode)", "SIM", "", "pronto",
            "Abre a venda, escolhe PIX na tela de pagamento e confirma o valor. Quando o QR aparecer grande na tela do caixa, aperta Esc (ou toca em \"Cancelar cobranca\").",
            "Na tela: titulo \"Cobranca cancelada\", texto \"cobranca cancelada pelo operador\" e o recado \"O cliente NAO foi cobrado.\" (Telas/Pagamento.xaml.cs:636-651). A janela do QR fecha sozinha. Nada gravado como pago: a linha da tef_transacao fica em cancelado e nenhuma parte entra na venda. Para casar com a frase que o roteiro cobra (\"OPERACAO CANCELADA\"), a evidencia e a auditoria e o campo 030-000 da…"),
        new(56, "Venda por QRCode para PIX e carteiras digitais (R$ 500,00, PIX C6 BANK)", "SIM", "500,00", "pronto",
            "Abre a venda, monta uma comanda de R$ 500,00 (por exemplo 3 itens de R$ 153,00 mais 2 de R$ 20,50), toca Finalizar, escolhe PIX, digita 50000 e confirma. Mostra o QR da tela para o cliente ler e espera a aprovacao chegar sozinha.",
            "O QR aparece na tela do caixa, grande e legivel por celular. Depois da leitura, a tela vira paga, a janela do QR fecha sozinha e as duas vias saem na impressora. Na base: tef_transacao situacao pago, com nsu preenchido (Pix pelo TEF vem sem codigo de autorizacao, so com NSU, e o PDV ja usa o NSU como carimbo, Telas/Pagamento.xaml.cs:600-605). Na auditoria tem que aparecer a linha \"pgweblib:…"),
        new(57, "Cancelamento PIX (tem que ser negado pelo host)", "SIM", "", "depende de voce",
