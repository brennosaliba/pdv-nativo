...
public static class RoteiroTef
{
    ...
    public static readonly IReadOnlyList<PassoTef> Passos = new PassoTef[]
    {
        ...
        new(24, "Cancelamento bem-sucedido #3 (da venda de R$ 12.345,67)", "SIM", "12.345,67", "depende de voce",
            "Mesmo caminho do passo 22, escolhendo o pagamento de R$ 12.345,67 pelo NSU, com o código do autenticador do dono.",
            "Igual ao passo 23. A PayGo avisou em 10/09/2026 que este cancelamento é OBRIGATÓRIO (o roteiro impresso dizia opcional): sem o CNC da venda de R$ 12.345,67 a planilha volta."),
